...
def print_mission_breakdown(results,filename='mission_breakdown.dat', units="imperial"):
    ...
    for key in results.segments.keys():        #loop for all segments
        ...
        WCf =  segment.conditions.weights.extra_mass[-1]                  #Final Segment Cryogen weight [kg]
        WCi =  segment.conditions.weights.extra_mass[0]                   #Initial Segment Cryogen weight [kg]
        ...
        if "vehicle_alternative_rate" in results.segments[0].conditions.weights:
